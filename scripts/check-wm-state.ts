...
import { addTab, closeTab, switchTab } from '../src/lib/wm/tabs.ts'
import { AREA, ALPHA, BETA, APPS, emptyState } from './lib/wm-fixtures.ts'
...
const MULTI_APPS: readonly AppDefinition[] = [MULTI_APP]
