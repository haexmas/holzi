// Part of `pnpm check:shell-state` (spec 015-workspace-shell): geometry (geometry.ts) and
// hydration (layoutState.ts's `hydrate`). Split from check-shell-state.ts per plan.md Complexity
// Tracking (T059).
...
import { AREA, ALPHA, BETA, APPS } from './lib/shell-fixtures.ts'
