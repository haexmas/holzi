// Part of `pnpm check:shell-navigation` (spec 020-tab-navigation): the keyboard shortcuts of
// Shell actions (keybindings.ts) — chord normalization, platform detection, chord resolution
// against the shipped catalog and yielding to focused text fields (FR-017). Split from
// check-shell-actions.ts to stay below the 500-line limit.
