...
| Der gemergte Vertrag schreibt „cross-host handover deferred" fest | Widerspricht der Festlegung vom 2026-09-08; Vertrag nachziehen | S | gering | `b4533a2`, Abschnitt Device-ID model |
...
**Bewusst noch nicht angefasst**: `specs/001-frontend-onboarding/spec.md` (User Story 3, FR-011), `tasks.md` und `quickstart.md` tragen die Formulierung „same-host" ebenfalls an insgesamt acht Stellen. Der Rückbau dort ist substantiell — User Story 3 wurde vollständig auf einen Einzelrechner-Restore umgeschrieben — und betrifft eine bereits geprüfte und gemergte Spezifikation. Da Import und Restore im MVP ohnehin zurückgestellt sind, wird dieser Rückbau mit dem Zuschnitt des Import-Flows nachgeholt, nicht vorgezogen. Bis dahin gilt: der Vertrag und dieser Plan sind die Wahrheit, die Onboarding-Spec hinkt an dieser Stelle hinterher.
...
- Die Onboarding-Spec trägt an acht Stellen noch „same-host"-Formulierungen aus einer Reviewrunde, die den Kopierweg als Scope-Entscheidung statt als Abhängigkeitslücke beschreiben. Beim Zuschnitt des Import-Flows zurückbauen. Wer vorher dort liest, muss wissen, dass Vertrag und dieser Plan aktueller sind.
