...
**Onboarding-Härtung und Modellwahl-Persistenz — nächster PR** (Design in [ADR-0001](../docs/adr/0001-device-scoped-data-convention.md) festgelegt am 2026-09-10 nach Grill-Session). Aktuell wird der Katalog-Panel nur bei komplett leerer Modell-Umgebung angezeigt und die Modellwahl vergisst sich zwischen Vault-Öffnungen — das nervt insbesondere in der Adoption (Vault-Datei auf neues Gerät kopiert, keine lokalen GGUFs, aber synchronisierte api_key-Provider-Modelle da). Der PR ändert:
