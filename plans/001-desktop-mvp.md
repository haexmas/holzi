...
Ebenfalls bereinigt: `specs/001-frontend-onboarding/spec.md` (User Story 3 samt Akzeptanzszenarien, FR-011, neu FR-011a), `tasks.md` (T055 und dessen Test) und `quickstart.md`. Dort stand die „same-host"-Formulierung an acht weiteren Stellen. User Story 3 beschreibt jetzt einen Ablauf für beide Fälle — der Unterschied ist allein, ob die Geräte-UUID bereits bekannt ist — und die Abhängigkeitslücke steht als solche benannt statt als Scope-Grenze.
