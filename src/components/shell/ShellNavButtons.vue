 ...
 * T023/T034, FR-015/FR-016, contracts/shell-actions.md §6), left of the tab
...
const runGo = useAction('shell.tab.go')
...
const label = computed<Record<Direction, string>>(() => ({
  back: t('shell.nav.back'),
  forward: t('shell.nav.forward'),
}))
