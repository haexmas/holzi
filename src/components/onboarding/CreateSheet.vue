...
async function onSubmit() {
  ...
  try {
    ...
    // FR-016: keep the value only until the create succeeds. Clear it here, before emitting —
    // `onCreated` navigates away instead of ever setting `open` back to `false`, so the dismiss
