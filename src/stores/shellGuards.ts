...
/**
 * Close-guard queries of the Shell store (spec 015-workspace-shell, FR-014,
 * FR-021), moved out of `stores/shell.ts` unchanged to keep it below the
 * 500-line limit when spec 020 added navigation there.
 */
export function createShellGuards(
  state: ShellState,
