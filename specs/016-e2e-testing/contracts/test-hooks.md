...
| `data-testid="lock-instance"`                                    | The lock button in the sidebar and the one in the header (only one is displayed at a given width; the helper clicks the displayed one) | `src/pages/chat/[instance].vue` (1316 lines)             | 2           |
