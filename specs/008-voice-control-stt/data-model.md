...
| `voice.active_stt_provider` | `PrefScope::Device(device_uuid)` | Provider-`Uuid` als String | Id des gebündelten lokalen Transkriptions-Providers | Welche Transkriptionsquelle auf diesem Gerät aktiv ist (FR-012). Geräte-lokal, weil an Hardware/Netzwerksituation des jeweiligen Geräts gekoppelt (research.md §6). |
...
FR-004 sind exklusiv für dieselbe Transkription).
