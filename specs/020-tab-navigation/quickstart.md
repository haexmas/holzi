...
1–5 aus [data-model.md](./data-model.md) ab sowie Push/Replace/No-op, die
...
| M13 | In den DevTools `history.back()` ausführen (simuliert System-Zurück) — mit Historie, ohne Historie, bei offener Fensterübersicht; dasselbe unter 768 px Breite | mit Historie: oberster Tab zurück; offene Übersicht: schließt; ohne Historie normal: nichts; ohne Historie kompakt: Fensterübersicht öffnet; die Vault bleibt immer offen | US3 AS4–5, FR-019/020 |
...
- Die echte Android-Zurück-Geste: holzi hat noch kein Android-Target (research
  R7). M13 prüft denselben Pfad auf dem Desktop.
